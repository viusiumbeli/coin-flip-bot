...
class ATRCalculator {
     ...
     */
    fun calculateATR(candles: List<Candle>, period: Int = 10): List<Candle> {
        ...
        var atr = trueRanges.take(period).reduce { acc, tr -> acc + tr }
     ...
     */
    fun getATRForCandle(candles: List<Candle>, index: Int): BigDecimal? {
