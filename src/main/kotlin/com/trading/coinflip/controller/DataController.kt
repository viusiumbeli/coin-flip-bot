...
import com.trading.coinflip.dto.DataStatus
import com.trading.coinflip.dto.SyncRequest
import com.trading.coinflip.dto.SyncResult
...
class DataController(
    ...
    @PostMapping("/sync")
    fun syncData(@RequestBody request: SyncRequest): ResponseEntity<SyncResult> {
        return try {
